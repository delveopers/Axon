...
void vector_dot_ops(float* a, float* b, float* out, size_t size) { dot_array_ops(a, b, out, size); }
void vector_inner_product_ops(float* a, float* b, float* out, size_t size) { dot_array_ops(a, b, out, size); }
